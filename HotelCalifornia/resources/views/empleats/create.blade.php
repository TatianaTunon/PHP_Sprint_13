...
@csrf <!--token-->
<h3 class="p-3 mb-2 col-md-6 bg-primary text-white">Nueva Empleado</h3>
...
<!--TELÉFONO-->
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input name=departament_id type="text" class="form-control" id="departament_id" placeholder="departament_id" value="{{ old('departament_id') }}">
