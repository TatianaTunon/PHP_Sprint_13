  ...
  <script src="{!! asset ('theme/vendor/jquery-3.2.1.min.js') !!}"></script>
    ...
    <script src="{!! asset ('theme/vendor/vector-map/jquery.vmap.js') !!}"></script>
    <script src="{!! asset ('theme/vendor/vector-map/jquery.vmap.min.js') !!}"></script>
    <script src="{!! asset ('theme/vendor/vector-map/jquery.vmap.sampledata.js') !!}"></script>
    <script src="{!! asset ('theme/vendor/vector-map/jquery.vmap.world.js') !!}"></script>
