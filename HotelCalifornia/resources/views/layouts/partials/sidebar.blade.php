...
<aside class="menu-sidebar2">
    <div class="logo">
        <a href="#">
            <img src="{!! asset ('theme/images/icon/logo-white.png') !!}" alt="Cool Admin" />
        </a>
    </div>
    <div class="menu-sidebar2__content js-scrollbar1">
        <div class="account2">
            <div class="image img-cir img-120">
                <img src="{!! asset ('theme/images/icon/avatar-big-01.jpg') !!}" alt="John Doe" />
            </div>
            ...
            <ul class="list-unstyled navbar__list">
                ...
                <li>
                    <a href="{{route('empleats.index')}}">
                        <i class="fas fa-users"></i>Empleats</a>
                </li>
                <li>
